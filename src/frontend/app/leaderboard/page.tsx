      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
          <div className="inline-flex items-center justify-center gap-3 mb-4">
            ...
            <h1 className="text-4xl font-bold bg-gradient-to-r from-yellow-500 to-amber-500 dark:from-yellow-400 dark:to-amber-400 bg-clip-text text-transparent">
              Leaderboard
            </h1>
          </div>
            ...
            {(Object.keys(timeFrameLabels) as TimeFrame[]).map((tf) => (
              <button
                ...
                className={`px-4 py-2 text-sm font-medium rounded-lg transition-all ${
                  timeFrame === tf
                    ? 'bg-gradient-to-r from-primary-600 to-accent-600 dark:from-purple-600 dark:to-cyan-600 text-white'
              ...
              <div className="p-6 pb-0">
                <div className="flex flex-col sm:flex-row justify-center items-center sm:items-end gap-4 sm:gap-4">
                  ...
                  {leaderboard[1] && (
                    ...
                    >
                      <div className="w-20 h-20 mx-auto mb-2 rounded-full bg-gradient-to-br from-slate-200 to-slate-300 dark:from-slate-500/30 dark:to-slate-400/30 border-2 border-slate-300 dark:border-slate-500/50 flex items-center justify-center">
                      ...
                      <div className="h-16 w-20 bg-gradient-to-t from-slate-200 to-transparent dark:from-slate-500/20 dark:to-transparent rounded-t-lg mt-2 flex items-end justify-center pb-2">
                  ...
                  {leaderboard[0] && (
                    ...
                    >
                      <div className="relative">
                        ...
                        <div className="w-24 h-24 mx-auto mb-2 rounded-full bg-gradient-to-br from-yellow-200 to-amber-300 dark:from-yellow-500/30 dark:to-amber-500/30 border-2 border-yellow-400 dark:border-yellow-500/50 flex items-center justify-center">
                      ...
                      <div className="h-24 w-24 bg-gradient-to-t from-yellow-200 to-transparent dark:from-yellow-500/20 dark:to-transparent rounded-t-lg mt-2 flex items-end justify-center pb-2">
                  ...
                  {leaderboard[2] && (
                    <motion.div
                      ...
                      className="text-center"
                    >
                      <div className="w-20 h-20 mx-auto mb-2 rounded-full bg-gradient-to-br from-amber-200 to-orange-300 dark:from-amber-600/30 dark:to-orange-600/30 border-2 border-amber-400 dark:border-amber-600/50 flex items-center justify-center">
                      ...
                      <div className="h-12 w-20 bg-gradient-to-t from-amber-200 to-transparent dark:from-amber-600/20 dark:to-transparent rounded-t-lg mt-2 flex items-end justify-center pb-2">
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.3 }}
          className="mt-8 bg-gradient-to-br from-primary-50 to-accent-50 dark:from-slate-800/50 dark:to-purple-900/30 rounded-2xl border border-primary-200 dark:border-slate-700/50 p-6 relative overflow-hidden"
        >
          {/* Background decoration */}
          <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-yellow-400/20 to-amber-500/20 rounded-full blur-2xl" />
