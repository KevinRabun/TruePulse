...
class UserCreate(UserBase):
    ...
    phone_number: str = Field(..., min_length=10, max_length=20, description="Phone number for SMS verification")
...
class UserDemographics(BaseModel):
    ...
    region: Optional[str] = Field(
        None,
        description="Region/State (legacy field)"
    )
    ...
    political_leaning: Optional[str] = Field(
        None,
        description="General political leaning (optional, self-reported)"
    )
    ...
    religious_affiliation: Optional[str] = Field(
        None,
        description="Religious affiliation (optional, self-reported)"
    )
    ethnicity: Optional[str] = Field(
        None,
        description="Ethnic background (optional, self-reported)"
    )
    ...
    parental_status: Optional[str] = Field(
        None,
        description="Parental status (e.g., 'no children', 'parent')"
    )
    housing_status: Optional[str] = Field(
        None,
        description="Housing status (e.g., 'own', 'rent')"
    )
