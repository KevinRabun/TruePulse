...
class FraudConfig:
    ...
    REQUIRE_EMAIL_VERIFIED = getattr(
        settings, "FRAUD_REQUIRE_EMAIL_VERIFIED", True
    )
    REQUIRE_PHONE_VERIFIED = getattr(
        settings, "FRAUD_REQUIRE_PHONE_VERIFIED", True
    )
    REQUIRE_BOTH_VERIFIED = getattr(
        settings, "FRAUD_REQUIRE_BOTH_VERIFIED", True
    )
...
class BehavioralAnalysisService:
    ...
    def analyze(
        ...
        total_interaction = (
            signals.mouse_move_count + 
            signals.mouse_click_count + 
