...
Return your response as JSON."""
    ...
    def _generate_mock_poll(self, event: NewsEvent) -> GeneratedPoll:
        ...
        mock_questions = {
            "Environment": {
                "question": f"Regarding recent climate discussions, what approach do you think governments should prioritize?",
                "choices": [
            ...
            "Technology": {
                "question": f"How should AI technology be regulated?",
                "choices": [
...
{{
        ...
        if self._openai_client:
            try:
                ...
                response = await self._openai_client.chat.completions.create(
                    ...
                    messages=[
                        {"role": "system", "content": "You are a bias detection expert. Respond only with valid JSON."},
                        {"role": "user", "content": prompt},
                    ],
    ...
    def _heuristic_bias_check(self, poll: GeneratedPoll) -> dict:
        ...
        loaded_words = [
            ...
            "clearly", "everyone knows", "radical", "extreme",
            "dangerous", "crisis", "disaster", "freedom", "liberty",
        ]
