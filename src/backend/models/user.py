...
class User(Base):
    ...
    flash_polls_per_day: Mapped[int] = mapped_column(Integer, default=5)  # Max flash poll notifications per day (0 = unlimited)
    flash_polls_notified_today: Mapped[int] = mapped_column(Integer, default=0)  # Counter for today's flash notifications
